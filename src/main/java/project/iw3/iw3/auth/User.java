...
public class User implements UserDetails {
	...
	public static final String VALIDATION_LOCKED = "LOCKED"; //bloqueada por un tiempo corto
	public static final String VALIDATION_DISABLED = "DISABLED"; //largo plazo

	public String validate() { // para no tener que estar haciendo if en cualquier lado, directamente obtengo aca.
	...
	private Set<Role> roles; // set de roles.
